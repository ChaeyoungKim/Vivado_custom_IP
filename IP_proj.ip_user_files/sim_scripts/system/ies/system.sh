...
execute()
{
  irun $irun_opts \
       ...
       -top glbl \
       glbl.v \
       +incdir+"$ref_dir/../../../../IP_proj.srcs/sources_1/bd/system/ipshared/ec67/hdl" \
       +incdir+"$ref_dir/../../../../IP_proj.srcs/sources_1/bd/system/ipshared/00a3/hdl" \
       +incdir+"../../../../IP_proj.srcs/sources_1/bd/system/ipshared/ec67/hdl" \
       +incdir+"../../../../IP_proj.srcs/sources_1/bd/system/ipshared/00a3/hdl" \
       +incdir+"../../../../IP_proj.srcs/sources_1/bd/system/ip/system_zynq_ultra_ps_e_0_0_1/sim_tlm" \
       +incdir+"../../../../IP_proj.srcs/sources_1/bd/system/ip/system_zynq_ultra_ps_e_0_0_1" \
